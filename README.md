...
Rewritten based on [this user's code](https://github.com/cc-code-examples/bright-moose-721880/blob/main/src/main.rs).

At the time of writing this, I'm still stuck at stage #NY9 - `Pipelines with built-ins`.
